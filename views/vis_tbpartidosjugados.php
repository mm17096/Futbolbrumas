...
<body class="nav-md">
            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-6  ">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2><i class="fa fa-list-alt"></i> Partidos Jugados</h2>
                            ...
                            <div id="modalResumen" class="modal fade">
                                <div class="modal-dialog">
                                    <div class="modal-content">

                                        <div class="modal-header">
                                            <h4 class="modal-title fa fa-eye"> Resumen de Partido</h4>
    ...
    <script src="../scripts/partidosjugados/partidosjugados.js"></script>
