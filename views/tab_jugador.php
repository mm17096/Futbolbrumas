<table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%" >
  ...
  <tbody>
    ...
    <tr>
      <th scope="row" id="id"><?php  echo $value->getIdjugador(); ?></th>
      <td ><?php echo $value->getNombre();?> <?php echo $value->getApellido();?></td>                             
      <td align="center"><?php echo str_replace('-','/',date('d-m-Y',strtotime($value->getFechanacimiento())));?></td>                             
      ...
      <td>  
        <div class="btn-group" role="group" aria-label="Basic example">
          ...
          <button href="#dar_baja"  data_target="dar_baja"  class="btn btn-round btn-alta"  data-toggle="modal" data-idjugador='<?php  echo $value->getIdjugador(); ?>'>
            <li class="fa fa-thumbs-o-up"></li>
            <!--fa fa-thumbs-o-up -->
          </button>
          
        <?php }else{ ?>
          <button href="#dar_alta" type="button" class="btn btn-round btn-baja" data-toggle="modal" data-idjugador="<?php  echo $value->getIdjugador(); ?>">
