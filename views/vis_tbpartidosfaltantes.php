...
<body class="nav-md">
            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-6  ">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2><i class="fa fa-th-list"></i> Partidos por Jugar</h2>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header">
                                            <h4 class="modal-title fa fa-eye"> Formacion de los Equipos</h4>
    ...
    <script src="../scripts/partidosporjugar/partidosporjugar.js"></script>
