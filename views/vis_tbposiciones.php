...
<body class="nav-md">
            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-6  ">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2><i class="fa fa-list-ol"></i> Datos de Posiciones</h2>
                            ...
                            <div class="x_content">
                             ...
                             <div id="modalPartidos" class="modal fade">
                                <div class="modal-dialog">
                                    <div class="modal-content">

                                        <div class="modal-header">
                                            <h4 class="modal-title fa fa-eye"> Partidos Jugados</h4>
    ...
    <script src="../scripts/posiciones/posiciones.js"></script>
