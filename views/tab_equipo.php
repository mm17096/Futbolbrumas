<table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
  ...
  <tbody>
    ...
    if ($_SESSION['identidad']->tipo == "usuario") {
      $fila = $daoE->lista_Equipo_es($_SESSION['identidad']->dui);
    } else {
      $fila = $daoE->listaEquipoE();
    }
      ...
      <tr>
        ...
        <td align="center">
          <div class="btn-group" role="group" aria-label="Basic example">
            ...
            <button href="#editEquipoModal" class="btn btn-round btn-editar" data-toggle="modal" data-idequipo='<?php echo $value->getIdequipo(); ?>' data-nombre='<?php echo $value->getNombre(); ?>' data-estado='<?php echo $value->getEstado(); ?>' data-idrepresentante='<?php echo $value->getIdrepresentante(); ?>' data-toggle="tooltip">
