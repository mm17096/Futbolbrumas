                    ...
                    <div class="right_col" role="main">
                        <div class="row">
                            <div class="col-md-12 col-sm-6  " >
                                <div class="x_panel"><!----->
                                    <div class="x_title">
                                        <h2><li class="glyphicon glyphicon-print">
                            ...
                            <div class="col-lg-4">
                            <button type="button" class="btn btn-round btn-guardar" onclick="verificar('../reportePDF/pdf_maximogoleadores.php')">
                                <li   class="glyphicon glyphicon-file" ></li>Generar PDF
                            </button>
                            </div> 
                            </div>
                            </form>
