...
<head>
    ...
    <title>Tabla de Mayor Goleador</title>
...
<body class="nav-md">
            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-6  ">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2><i class="fa fa-signal"></i> Mayores Goleadores</h2>
    ...
    <script src="../scripts/mayorgoleador/mayorgoleador.js"></script>
